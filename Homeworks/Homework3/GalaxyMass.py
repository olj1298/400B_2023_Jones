...
print(f'Mass of halo particles in Milky Way is {totmassMW1:.3E}') #round answer to three places
totmassMW2 = ComponentMass(MWfile,2) #Mass of all disk particles in Milky Way   
print(f'Mass of disk particles in Milky Way is {totmassMW2:.3E}') #round answer to three places
totmassMW3 = ComponentMass(MWfile,3) #Mass of all Buldge particlces in Milky Way
print(f'Mass of buldge particles in Milky Way is {totmassMW3:.3E}') #round answer to three places
totmassMW = totmassMW1+totmassMW2+totmassMW3 #sum of all particle types
print(f'Total mass of the Milky Way is {totmassMW:.3E}') #round answer to three places
fbarMW = (totmassMW2+totmassMW3)/totmassMW #fbar is ((disk + buldge) particles mass/totalmass of all particles)
print(f'f_bar of M33 is {fbarMW:.3E}') #round answer to three places

totmassM311 = ComponentMass(M31file,1)#Mass of all Halo particles in M31
print(f'Mass of halo particles in M31 is {totmassM311:.3E}') #round answer to three places
totmassM312 = ComponentMass(M31file,2)#Mass of all Disk particles in M31
print(f'Mass of disk particles in M31 is {totmassM312:.3E}') #round answer to three places
totmassM313 = ComponentMass(M31file,3)#Mass of all Buldge particlces in M31
print(f'Mass of buldge particles in M31 is {totmassM313:.3E}') #round answer to three places
totmassM31 = totmassM311+totmassM312+totmassM313 #sum of all particle types
print(f'Total mass of the M31 is {totmassM31:.3E}') #round answer to three places
fbarM31 = (totmassM312+totmassM313)/totmassM31 #fbar is ((disk + buldge) particles mass/totalmass of all particles)
print(f'f_bar of M33 is {fbarM31:.3E}') #round answer to three places

totmassM331 = ComponentMass(M33file,1)#Mass of all Halo particles in M33
print(f'Mass of halo particles in M33 is {totmassM331:.3E}') #round answer to three places
totmassM332 = ComponentMass(M33file,2)#Mass of all Disk particles in M33  
print(f'Mass of disk particles in M33 is {totmassM332:.3E}') #round answer to three places
...
print(f'Total mass of the M33 is {totmassM33:.3E}') #round answer to three places
fbarM33 = totmassM332/totmassM33 #fbar is (disk particles mass/totalmass of all particles)
print(f'f_bar of M33 is {fbarM33:.3E}') #round answer to three places

localmass = totmassMW+totmassM31+totmassM33 #sum of particles in each galaxy in group
print(f'Mass of Local Group is {localmass:.3E}') #round answer to three places
