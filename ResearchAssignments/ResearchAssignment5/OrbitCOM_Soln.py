...
MW_orbit = np.genfromtxt(os.path.abspath('Orbit_MW.txt'),dtype=None,names=True) 
M31_orbit = np.genfromtxt(os.path.abspath('Orbit_M31.txt'),dtype=None,names=True) 
M33_orbit = np.genfromtxt(os.path.abspath('Orbit_M33.txt'),dtype=None,names=True) 
