...
#This Lab:
#Modify the template file of your choice to plot isochrones that correspond to the inferred star formation
#episodes (right panel of Figure 1) to recreate the dominant features of the CMD of Carina (left panel of Figure 1). 
...
#SETTINGS USED:  Y = 0.245 default   [Fe/H] = -2.0  alpha/Fe = -0.2
